...
$dbserver = "193.168.14.62";
$dbusername = "training_system";
$dbpassword = "123456";
$database = "training_system";

//$dbserver   = "127.0.0.1";
//$dbusername = "docker";
//$dbpassword = "qweasdzxc";
//$database   = "rsclass";
//其他配置
...
$no_show_table = array(
//'client', 'job', 'course_tem_product','course_tem_file','course_tem_version','course_tem','admin_menu','admin_role'
    'exam',
    'exam_answer',
    'exam_ques_re',
    'exam_question',
...
<html>
    <head>
        <meta charset="utf-8">
        <title>报名系统数据库文档<?php date("Y-m-d", time()) ?></title>
    ...
    <body>
        <div class="warp">
            <h1 style="text-align:center;">报名系统部分数据库文档<?php date("Y-m-d", time()) ?></h1>
            <?php echo $html; ?>
        </div>
    </body>
</html>